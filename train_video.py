...
path = "D:\CODE\ML\ML_FINAL_PROJECT\Video_data" # folder with all the class folders
labelFile =  "D:\CODE\ML\ML_FINAL_PROJECT\labels.csv"# file with all names of classes
